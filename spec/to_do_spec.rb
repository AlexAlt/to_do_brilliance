...
describe(Task) do
  ...
  describe('#==') do
    it('is the same task if it has the same description') do
      task1 = Task.new({:id => nil, :description => 'learn SQL', :list_id => 1})
      task2 = Task.new({:id => nil, :description => 'learn SQL', :list_id => 1})
  ...
  describe('#save') do
    it('adds task to the array of saved tasks') do
      test_task = Task.new({:id => nil, :description => 'learn SQL', :list_id => 1})
      test_task.save()
